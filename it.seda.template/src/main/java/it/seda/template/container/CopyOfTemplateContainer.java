 ...
 *
 */
public class CopyOfTemplateContainer {

	private Logger logger = LoggerFactory.getLogger(CopyOfTemplateContainer.class);
	...
	public CopyOfTemplateContainer(TemplateContext context) {
